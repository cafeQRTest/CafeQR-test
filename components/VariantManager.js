    ...
    <div className="vm-overlay" onClick={onClose}>
      ...
      <style jsx>{`
        ...
        .vm-input {
          ...
          border-radius: 10px; fontSize: 14px; outline: none; background: #f9fafb;
          transition: border-color 0.2s;
        }
        .vm-input:focus { border-color: #f97316; }
        .vm-input-small {
          flex: 1; padding: 8px 12px; border: 1px solid #d1d5db;
          border-radius: 8px; fontSize: 13px; outline: none; background: #ffffff;
        }
        .vm-primary-btn {
