...
let paymentDisplay = payMethod.toUpperCase();
  if (payMethod === 'mixed' && mixed) {
    paymentDisplay = `MIXED (₹${mixed.cash_amount} Cash + ₹${mixed.online_amount} ${mixed.online_method?.toUpperCase()})`;
  }
  ...
  doc.text(`Date: ${istDateString.toLocaleString()}`, rightX + 12, topY + 40)
