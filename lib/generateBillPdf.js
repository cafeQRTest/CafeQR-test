...
export async function generateBillPdf(payload, restaurantId) {
  ...
  // Optimized column widths to give more space to Description
  const col = {
    hsn:  { x: leftX, w: 50 },  // Reduced from 70
    desc: { x: leftX + 54, w: contentWidth - (54 + 40 + 70 + 40 + 70 + 85) },
    qty:  { x: pageWidth - 40 - (40 + 70 + 40 + 70 + 85), w: 40 }, // Reduced from 56
    rate: { x: pageWidth - 40 - (70 + 40 + 70 + 85), w: 70 },      // Reduced from 80
    taxp: { x: pageWidth - 40 - (40 + 70 + 85), w: 40 },           // Reduced from 46
    taxa: { x: pageWidth - 40 - (70 + 85), w: 70 },                // Reduced from 80
    total:{ x: pageWidth - 40 - 85, w: 85 },                       // Reduced from 90
  }
